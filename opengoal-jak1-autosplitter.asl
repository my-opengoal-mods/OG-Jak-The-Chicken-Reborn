...
startup {
  ...
  Actionstring, bool DebugOutput = (text, setting) = {
    if (setting) {
  ...
  ActionListDictionaryString, dynamic, string, int, Type, dynamic, bool, string, bool AddOption = (list, id, offset, type, splitVal, defaultEnabled, name, debug) = {
    var d = new DictionaryString, dynamic();
    d.Add(id, id);
    d.Add(offset, offset);
    d.Add(type, type);
  ...
  Actiondynamic, string AddToSettings = (options, parent) = {
    foreach (DictionaryString, dynamic option in options) {
  ...
  vars.optionLists = new ListListDictionaryString, dynamic();

    Per-level All Orbs Splits
   settings.Add(jak1_level_all_orbs, true, All Orbs per level);
   vars.allOrbs = new ListDictionaryString, dynamic();
   ...
   ActionListDictionaryString, dynamic, string, int, string AddScoutFlyOptions = (list, id_prefix, offset, name_prefix) = {
     for (int i = 1; i = 7; i++) {
   ...
   vars.trainingScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.village1ScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.beachScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.jungleScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.mistyScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.firecanyonScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.village2ScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.sunkenScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.swampScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.rollingScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.ogreScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.village3ScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.snowScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.caveScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.lavatubeScoutFlies = new ListDictionaryString, dynamic();
   ...
   vars.citadelScoutFlies = new ListDictionaryString, dynamic();
  ...
  var jak1_need_res_offset = 424;
    ...
    Training
   vars.trainingResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.trainingResolutions);
    ...
    Village 1
   vars.village1Resolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.village1Resolutions);
    ...
    Beach
   vars.beachResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.beachResolutions);
    ...
    Jungle
   vars.jungleResolutions = new ListDictionaryString, dynamic();
   ...
   Mort
  vars.mortResolutions = new ListDictionaryString, dynamic();
  ...
  vars.allMortOrbs = new ListDictionaryString, dynamic();
...
vars.optionLists.Add(vars.allMortOrbs);
   ...
   vars.optionLists.Add(vars.allOrbs);
   Misty
  vars.mistyResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.mistyResolutions);
    ...
    Fire Canyon
   vars.firecanyonResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.firecanyonResolutions);
    ...
    Village 2
   vars.village2Resolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.village2Resolutions);
    ...
    Sunken
   vars.sunkenResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.sunkenResolutions);
    ...
    Swamp
   vars.swampResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.swampResolutions);
    ...
    Rolling
   vars.rollingResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.rollingResolutions);
    ...
    Ogre Boss
   vars.ogrebossResolutons = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.ogrebossResolutons);
    ...
    Village 3
   vars.village3Resolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.village3Resolutions);
    ...
    Snowy
   vars.snowyResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.snowyResolutions);
    ...
    Spider Cave
   vars.spiderCaveResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.spiderCaveResolutions);
    ...
    Lava Tube
   vars.lavatubeResolutions = new ListDictionaryString, dynamic();
   ...
   vars.optionLists.Add(vars.lavatubeResolutions);
    ...
    Citadel
   vars.citadelResolutions = new ListDictionaryString, dynamic();
  ...
  vars.miscallenousTasks = new ListDictionaryString, dynamic();
...
init {
  ...
  var goal_struct_ptr = new IntPtr(memory.ReadValuelong(exported_ptr + 4));
  ...
  ActionMemoryWatcherList, IntPtr, ListDictionaryString, dynamic AddMemoryWatchers = (memList, bPtr, options) = {
    foreach (DictionaryString, dynamic option in options) {
      ...
      memList.Add(new MemoryWatcherbyte(finalOffset) { Name = option[id] });
  ...
  var watchers = new MemoryWatcherList{
    new MemoryWatcheruint(goal_struct_ptr + 212) { Name = currentGameHash }
  };
  ...
  foreach (ListDictionaryString, dynamic optionList in vars.optionLists) {
...
split {
  FuncListDictionaryString, dynamic, bool InspectValues = (list) = {
    var debugThisIter = false;
    if (vars.debugTick++ % 60 == 0) {
      debugThisIter = true;
    }
    foreach (DictionaryString, dynamic option in list) {
